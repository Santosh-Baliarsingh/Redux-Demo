...
const combineReducers = redux.combineReducers; // import combineReducers method
...
const cakeStore = createStore(rootReducer);
...
const iceCreamStore = createStore(rootReducer);
